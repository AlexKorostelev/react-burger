...
const BurgerIngredients = () => {
  const { ref: refBunInView, inView: bunInView } = useInView({ threshold: 0.5,});
  const { ref: refSauceInView, inView: sauceInView } = useInView({ threshold: 0.5,});
  const { ref: refMainInView, inView: mainInView } = useInView({ threshold: 0.5,});
  ...
  const ingredientGroupWithRef = (ref, forwardRef, groupName) => {
    return <div ref={ref}>
